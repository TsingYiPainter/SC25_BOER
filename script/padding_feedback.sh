#!/bin/bash
workdir=/data/zbw/MIG/MIG/SC25_BOER/jobs
...
&  (sleep 1 && cd $workdir &&  export export CUDA_MPS_PIPE_DIRECTORY=/tmp/nvidia-mps-$device  &&  export CUDA_MPS_LOG_DIRECTORY=/tmp/nvidia-log-$device \
